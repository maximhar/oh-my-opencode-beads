...
- \`bd update <ASSIGNED_ISSUE_ID> --status in_progress\` before starting assigned work
- For each newly created follow-up issue, \`bd update <id> --status in_progress\` before starting it (ONE at a time)
